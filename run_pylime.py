...
parser.add_argument('--omega', help='one-time change to the oemga for the current run [unit: s-1].  Note "" is necessary for a correct interpration of scientific notation.')
