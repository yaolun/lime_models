...
outdir = '/scratch/LIMEmods/pylime/YLY/run/testing/pylime_example/'
...
def input(macros):
  ...
  par.minScale          = 1.0*macros["AU"]
  par.pIntensity        = 10000
  par.sinkPoints        = 3000
  par.samplingAlgorithm = 1
  ...
  par.binoutputfile     = outdir+"restart.pop"
...
#  par.doSolveRTE        = False
  par.gridOutFiles      = ['','','','',outdir+"grid_5.ds"] # must be a list with 5 string elements, although some or all can be empty.
